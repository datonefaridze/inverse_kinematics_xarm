...
def move():
    ...
    # x, y, z
    target_position = [0.03, 0.03, 0.25]
    ...
    target_angles_degrees =  np.flip(target_angles_degrees[1:])
    ...
    desired_pos = [[x+2, float(target_angles_degrees[x])] for x in range(len(target_angles_degrees))]
